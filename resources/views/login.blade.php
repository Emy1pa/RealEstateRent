    ...
    <div class="bg-white w-full md:max-w-md lg:max-w-full md:mx-auto md:mx-0 md:w-1/2 xl:w-1/3 h-screen px-6 lg:px-16 xl:px-12
      ...
      <div class="w-full h-100">
        ...
        <form class="mt-6" action="#" method="POST">
          ...
          <button type="submit" class="w-full block bg-[#EBC000] hover:bg-indigo-400 focus:bg-indigo-400 text-white font-semibold rounded-lg
        ...
        <p class="mt-8">You don't have an account? <a href="#" class="text-[#EBC000] hover:text-[#BF9C00] font-semibold">REGISTER</a></p>
